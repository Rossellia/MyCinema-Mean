...
import { AdminmovieComponent } from './admin/adminmovie/adminmovie.component';
import { EditmovieComponent } from './admin/editmovie/editmovie.component';
import { ShowprogramComponent } from './admin/showprogram/showprogram.component';
import { EdiprofileComponent } from './admin/ediprofile/ediprofile.component';
import { BookingComponent } from './booking/booking.component';
import { AdminroomComponent } from './admin/adminroom/adminroom.component';
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      {
        path: 'showprogram', component: ShowprogramComponent
      },
      {
